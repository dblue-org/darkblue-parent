 ...
 */
@Getter
public class DictionaryItemUpdateEvent extends ApplicationEvent {

    private final transient Dictionary dictionary;

    private final transient DictionaryItem item;

    public DictionaryItemUpdateEvent(Object source, Dictionary dictionary, DictionaryItem item) {
        super(source);
