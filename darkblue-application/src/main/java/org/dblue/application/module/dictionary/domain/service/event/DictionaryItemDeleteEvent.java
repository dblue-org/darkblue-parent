 ...
 */
@Getter
public class DictionaryItemDeleteEvent extends ApplicationEvent {

    private final transient Dictionary dictionary;

    private final transient DictionaryItem item;

    public DictionaryItemDeleteEvent(Object source, Dictionary dictionary, DictionaryItem item) {
        super(source);
