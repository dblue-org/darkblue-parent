...
@Order(2)
@Component
public class BooleanValueConverter implements PropertyValueConverter<Boolean> {

    private static final StringToBooleanConverter CONVERTER = new StringToBooleanConverter();

    @Override
    public boolean isSupported(int propertyType) {
        return PropertyType.BOOL.equalsTo(propertyType);
    }
    ...
    public Optional<Boolean> convert(String value) {
        ...
        Boolean bool = CONVERTER.convert(value);
