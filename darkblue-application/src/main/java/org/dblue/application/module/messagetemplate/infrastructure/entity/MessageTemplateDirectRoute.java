...
@Setter
@Entity
@Table(name = "tb_sys_message_template_direct_route")
public class MessageTemplateDirectRoute extends AbstractCreateAuditingEntity {
    /**
     * 路由ID
     */
    @Id
    @Size(max = 32)
    @Column(name = "message_template_direct_route_id", nullable = false, length = 32)
