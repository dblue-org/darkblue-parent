...
@Data
public class MessageTemplateGroupUpdateDto extends MessageTemplateGroupAddDto {
    ...
    public MessageTemplateGroup asEntity() {
        MessageTemplateGroup messageTemplateGroup = new MessageTemplateGroup();
        messageTemplateGroup.setMessageTemplateGroupId(this.getMessageTemplateGroupId());
        messageTemplateGroup.setMessageTemplateGroupName(this.getMessageTemplateGroupName());
