 ...
 *
 * @author xie jin
 * @since 1.0.0  2024/7/3 下午2:05
 */
@SupportedAnnotationTypes({"com.querydsl.core.annotations.*", "jakarta.persistence.*", "javax.persistence.*"})
public class JPANewAnnotationProcessor extends AbstractQuerydslProcessor {
    @Override
    protected Configuration createConfiguration(RoundEnvironment roundEnv) {
        ...
        return new JPANewConfiguration(roundEnv, processingEnv,
