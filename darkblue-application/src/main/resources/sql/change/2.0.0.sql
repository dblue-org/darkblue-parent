...
(
    ...
    message_template_group_id varchar(64)             not null comment '消息模板组ID',
...
(
    message_template_direct_route_id varchar(64)  not null comment '路由ID'
        primary key,
    message_template_id              varchar(64)  not null comment '模板ID',
    router_type                      int          not null comment '路由类型(1-PC;2-Android;3-IOS;4-小程序;5-H5)',
    router_link                      varchar(256) not null comment '路由地址',
    create_time                      datetime     null comment '创建时间',
    create_user                      varchar(64)  null comment '创建人'
) comment '模板直接路由';
...
(
    message_template_tag_id varchar(64)  not null comment '标签ID'
        primary key,
    message_template_id     varchar(64)  not null comment '模板ID',
    tag_name                varchar(256) not null comment '标签名称',
    show_conditional        varchar(256) not null comment '显示条件',
    create_user             varchar(64)  null comment '创建人',
    create_time             datetime     null comment '创建时间'
) comment '模板标签配置';
...
(
    message_template_button_id varchar(64)  not null comment '按钮ID'
        primary key,
    message_template_id        varchar(64)  not null comment '模板ID',
    ...
    show_conditional           varchar(256) not null comment '按钮条件',
...
(
    message_template_action_route_id varchar(64)  not null comment '路由ID' primary key,
    message_template_action_id       varchar(64)  not null comment '按钮ID',
    message_template_id              varchar(64)  not null comment '模板ID',
    router_type                      int          not null comment '路由类型(1-PC;2-Android;3-IOS;4-小程序;5-H5)',
    router_link                      varchar(256) not null comment '路由地址',
    create_time                      datetime     null comment '创建时间',
...
(
    ...
    message_template_group_id varchar(64)  not null comment '消息模板组ID',
    message_template_id       varchar(64)  not null comment '模板ID',
    message_title             varchar(60)  not null comment '消息标题',
    message_content           longtext     not null comment '主要内容',
    to_user                   varchar(64)  not null comment '接收人',
...
(
    notification_route_id varchar(64)  not null comment '路由ID'
        primary key,
    notification_id       varchar(64)  not null comment '消息通知ID',
    router_type           int          not null comment '路由类型(1-PC;2-Android;3-IOS;4-小程序;5-H5)',
    router_link           varchar(256) not null comment '路由地址',
    create_time           datetime     null comment '创建时间',
    create_user           varchar(64)  null comment '创建人'
...
(
    ...
    starter                   varchar(64)  not null comment '发起人',
    to_user                   varchar(64)  not null comment '接收人',
    ...
    service_state_name        varchar(60)  null comment '业务状态名称',
...
(
    todo_action_id varchar(64)  not null comment '操作ID'
        primary key,
    todo_id        varchar(64)  not null comment '待办ID',
    action_name    varchar(64)  not null comment '操作名称',
    action_mark    varchar(64)  null comment '操作标识',
...
(
    todo_action_route_id varchar(64)  not null comment '待办操作路由ID'
        primary key,
    todo_action_id       varchar(64)  not null comment '操作ID',
    todo_id              varchar(64)  not null comment '待办ID',
    router_type          int          not null comment '路由类型(1-PC;2-Android;3-IOS;4-小程序;5-H5)',
